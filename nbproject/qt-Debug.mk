...
# Generated by qmake (2.01a) (Qt 4.7.2) on: mar. avr. 3 18:29:13 2012
...
OBJECTS       = build/Debug/GNU-Linux-x86/MagistralClass.o \
		...
		build/Debug/GNU-Linux-x86/WindowAddClassroom.o \
		...
		build/Debug/GNU-Linux-x86/moc_WindowAddClassroom.o \
		build/Debug/GNU-Linux-x86/moc_QTimeSlot.o \
		build/Debug/GNU-Linux-x86/moc_WindowAddClassPeriod.o
...
$(TARGET): Gui/ui_WindowAddClassroom.h Gui/ui_WindowAdministrator.h Gui/ui_WindowEditTimeSlot.h Gui/ui_WindowAddClassPeriod.h Gui/ui_mainwindow.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) nbproject/build/Debug/GNU-Linux-x86/Zebulon1.0.0/ && $(COPY_FILE) --parents Gui/QSchedule.h Model/LectureHall.h Model/Controller.h Gui/WindowAdministrator.h sqlite/Database.h Model/PracticalClass.h Gui/mainwindow.h Model/PracticalClassroom.h Model/TimeSlot.h sqlite/lib/sqlite3.h Model/Schedule.h Model/Studient.h Model/ClassPeriod.h Gui/WindowEditTimeSlot.h Gui/ui_WindowEditTimeSlot.h Model/Group.h Gui/WindowAddClassroom.h Gui/QTimeSlot.h Model/TutorialClassroom.h Gui/ui_mainwindow.h sqlite/lib/sqlite3ext.h Model/Module.h Model/Classroom.h Gui/WindowAddClassPeriod.h Model/Date.h Model/MagistralClass.h Model/TutorialClass.h Model/Student.h nbproject/build/Debug/GNU-Linux-x86/Zebulon1.0.0/ && $(COPY_FILE) --parents Model/MagistralClass.cpp Model/Date.cpp Model/Module.cpp Gui/WindowAddClassPeriod.cpp Model/TutorialClassroom.cpp Model/PracticalClass.cpp Model/Controller.cpp Gui/QTimeSlot.cpp Model/TutorialClass.cpp Gui/main.cpp Model/TimeSlot.cpp Model/PracticalClassroom.cpp Model/ClassPeriod.cpp sqlite/lib/sqlite3.c Model/LectureHall.cpp Model/Schedule.cpp Model/Student.cpp Gui/QSchedule.cpp Model/Studient.cpp Gui/WindowAddClassroom.cpp Model/Classroom.cpp Model/Group.cpp Gui/WindowAdministrator.cpp Gui/WindowEditTimeSlot.cpp sqlite/Database.cpp Gui/mainwindow.cpp nbproject/build/Debug/GNU-Linux-x86/Zebulon1.0.0/ && $(COPY_FILE) --parents Gui/WindowAddClassroom.ui Gui/WindowAdministrator.ui Gui/WindowEditTimeSlot.ui Gui/WindowAddClassPeriod.ui Gui/mainwindow.ui nbproject/build/Debug/GNU-Linux-x86/Zebulon1.0.0/ && (cd `dirname nbproject/build/Debug/GNU-Linux-x86/Zebulon1.0.0` && $(TAR) Zebulon1.0.0.tar Zebulon1.0.0 && $(COMPRESS) Zebulon1.0.0.tar) && $(MOVE) `dirname nbproject/build/Debug/GNU-Linux-x86/Zebulon1.0.0`/Zebulon1.0.0.tar.gz . && $(DEL_FILE) -r nbproject/build/Debug/GNU-Linux-x86/Zebulon1.0.0
...
compiler_moc_header_make_all: Gui/moc/moc_QSchedule.cpp Gui/moc/moc_WindowAdministrator.cpp Gui/moc/moc_mainwindow.cpp Gui/moc/moc_WindowEditTimeSlot.cpp Gui/moc/moc_WindowAddClassroom.cpp Gui/moc/moc_QTimeSlot.cpp Gui/moc/moc_WindowAddClassPeriod.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) Gui/moc/moc_QSchedule.cpp Gui/moc/moc_WindowAdministrator.cpp Gui/moc/moc_mainwindow.cpp Gui/moc/moc_WindowEditTimeSlot.cpp Gui/moc/moc_WindowAddClassroom.cpp Gui/moc/moc_QTimeSlot.cpp Gui/moc/moc_WindowAddClassPeriod.cpp
Gui/moc/moc_QSchedule.cpp: Gui/QTimeSlot.h \
		Gui/QSchedule.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) Gui/QSchedule.h -o Gui/moc/moc_QSchedule.cpp

Gui/moc/moc_WindowAdministrator.cpp: Gui/mainwindow.h \
		Gui/QSchedule.h \
		Gui/QTimeSlot.h \
		Gui/WindowEditTimeSlot.h \
		Gui/WindowAddClassPeriod.h \
		Gui/ui_WindowAddClassPeriod.h \
...
Gui/moc/moc_WindowAddClassroom.cpp: Gui/ui_WindowAddClassroom.h \
		Gui/WindowAddClassroom.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) Gui/WindowAddClassroom.h -o Gui/moc/moc_WindowAddClassroom.cpp

Gui/moc/moc_QTimeSlot.cpp: Gui/QTimeSlot.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) Gui/QTimeSlot.h -o Gui/moc/moc_QTimeSlot.cpp

Gui/moc/moc_WindowAddClassPeriod.cpp: Gui/ui_WindowAddClassPeriod.h \
		Gui/WindowEditTimeSlot.h \
		Gui/mainwindow.h \
		Gui/QSchedule.h \
		Gui/QTimeSlot.h \
		...
		Gui/ui_WindowEditTimeSlot.h \
		Gui/WindowAddClassPeriod.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) Gui/WindowAddClassPeriod.h -o Gui/moc/moc_WindowAddClassPeriod.cpp
...
compiler_uic_make_all: Gui/ui_WindowAddClassroom.h Gui/ui_WindowAdministrator.h Gui/ui_WindowEditTimeSlot.h Gui/ui_WindowAddClassPeriod.h Gui/ui_mainwindow.h
compiler_uic_clean:
	-$(DEL_FILE) Gui/ui_WindowAddClassroom.h Gui/ui_WindowAdministrator.h Gui/ui_WindowEditTimeSlot.h Gui/ui_WindowAddClassPeriod.h Gui/ui_mainwindow.h
Gui/ui_WindowAddClassroom.h: Gui/WindowAddClassroom.ui
	/usr/bin/uic-qt4 Gui/WindowAddClassroom.ui -o Gui/ui_WindowAddClassroom.h
...
Gui/ui_WindowAddClassPeriod.h: Gui/WindowAddClassPeriod.ui
	/usr/bin/uic-qt4 Gui/WindowAddClassPeriod.ui -o Gui/ui_WindowAddClassPeriod.h
...
build/Debug/GNU-Linux-x86/WindowAddClassPeriod.o: Gui/WindowAddClassPeriod.cpp Gui/WindowAddClassPeriod.h \
		Gui/ui_WindowAddClassPeriod.h \
		Gui/WindowEditTimeSlot.h \
		Gui/mainwindow.h \
		Gui/QSchedule.h \
		...
		Gui/ui_WindowAdministrator.h \
		Gui/ui_WindowEditTimeSlot.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/WindowAddClassPeriod.o Gui/WindowAddClassPeriod.cpp
...
build/Debug/GNU-Linux-x86/WindowAddClassroom.o: Gui/WindowAddClassroom.cpp Gui/WindowAddClassroom.h \
		Gui/ui_WindowAddClassroom.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/WindowAddClassroom.o Gui/WindowAddClassroom.cpp
...
build/Debug/GNU-Linux-x86/moc_WindowAddClassroom.o: Gui/moc/moc_WindowAddClassroom.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/moc_WindowAddClassroom.o Gui/moc/moc_WindowAddClassroom.cpp
...
build/Debug/GNU-Linux-x86/moc_WindowAddClassPeriod.o: Gui/moc/moc_WindowAddClassPeriod.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/moc_WindowAddClassPeriod.o Gui/moc/moc_WindowAddClassPeriod.cpp
