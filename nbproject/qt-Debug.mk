...
# Generated by qmake (2.01a) (Qt 4.7.4) on: mer. avr. 4 23:49:27 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/Zebulon1.0.0/ && $(COPY_FILE) --parents Gui/QSchedule.h Model/LectureHall.h Model/Controller.h Gui/WindowAdministrator.h sqlite/Database.h Model/PracticalClass.h Gui/mainwindow.h Model/PracticalClassroom.h Model/TimeSlot.h sqlite/lib/sqlite3.h Model/Schedule.h Model/Studient.h Model/ClassPeriod.h Gui/WindowEditTimeSlot.h Gui/ui_WindowEditTimeSlot.h Model/Group.h Gui/WindowAddClassroom.h Gui/QTimeSlot.h Model/TutorialClassroom.h Gui/ui_mainwindow.h sqlite/lib/sqlite3ext.h Model/Module.h Model/Classroom.h Gui/WindowAddClassPeriod.h Model/Date.h Model/MagistralClass.h Model/TutorialClass.h Model/Student.h build/Debug/GNU-Linux-x86/Zebulon1.0.0/ && $(COPY_FILE) --parents Model/MagistralClass.cpp Model/Date.cpp Model/Module.cpp Gui/WindowAddClassPeriod.cpp Model/TutorialClassroom.cpp Model/PracticalClass.cpp Model/Controller.cpp Gui/QTimeSlot.cpp Model/TutorialClass.cpp Gui/main.cpp Model/TimeSlot.cpp Model/PracticalClassroom.cpp Model/ClassPeriod.cpp sqlite/lib/sqlite3.c Model/LectureHall.cpp Model/Schedule.cpp Model/Student.cpp Gui/QSchedule.cpp Model/Studient.cpp Gui/WindowAddClassroom.cpp Model/Classroom.cpp Model/Group.cpp Gui/WindowAdministrator.cpp Gui/WindowEditTimeSlot.cpp sqlite/Database.cpp Gui/mainwindow.cpp build/Debug/GNU-Linux-x86/Zebulon1.0.0/ && $(COPY_FILE) --parents Gui/WindowAddClassroom.ui Gui/WindowAdministrator.ui Gui/WindowEditTimeSlot.ui Gui/WindowAddClassPeriod.ui Gui/mainwindow.ui build/Debug/GNU-Linux-x86/Zebulon1.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/Zebulon1.0.0` && $(TAR) Zebulon1.0.0.tar Zebulon1.0.0 && $(COMPRESS) Zebulon1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/Zebulon1.0.0`/Zebulon1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/Zebulon1.0.0
