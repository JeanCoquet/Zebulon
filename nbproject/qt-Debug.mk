...
# Generated by qmake (2.01a) (Qt 4.7.4) on: ven. mars 16 16:25:44 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/Zebulon1.0.0/ && $(COPY_FILE) --parents Gui/QSchedule.h Model/LectureHall.h Model/Controller.h sqlite/Database.h Model/PracticalClass.h Gui/mainwindow.h Model/PracticalClassroom.h Model/TimeSlot.h sqlite/lib/sqlite3.h Model/Schedule.h Model/Studient.h Model/ClassPeriod.h Gui/WindowEditTimeSlot.h Model/Group.h Gui/QTimeSlot.h Model/TutorialClassroom.h sqlite/lib/sqlite3ext.h Model/Module.h Model/Classroom.h Model/Date.h Model/MagistralClass.h Model/TutorialClass.h Model/Student.h build/Debug/GNU-Linux-x86/Zebulon1.0.0/ && $(COPY_FILE) --parents Model/MagistralClass.cpp Model/Date.cpp Model/Module.cpp Model/TutorialClassroom.cpp Model/PracticalClass.cpp Model/Controller.cpp Gui/QTimeSlot.cpp Model/TutorialClass.cpp Gui/main.cpp Model/TimeSlot.cpp Model/PracticalClassroom.cpp Model/ClassPeriod.cpp sqlite/lib/sqlite3.c Model/LectureHall.cpp Model/Schedule.cpp Model/Student.cpp Gui/QSchedule.cpp Model/Studient.cpp Model/Classroom.cpp Model/Group.cpp Gui/WindowEditTimeSlot.cpp sqlite/Database.cpp Gui/mainwindow.cpp build/Debug/GNU-Linux-x86/Zebulon1.0.0/ && $(COPY_FILE) --parents Gui/WindowEditTimeSlot.ui Gui/mainwindow.ui build/Debug/GNU-Linux-x86/Zebulon1.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/Zebulon1.0.0` && $(TAR) Zebulon1.0.0.tar Zebulon1.0.0 && $(COMPRESS) Zebulon1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/Zebulon1.0.0`/Zebulon1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/Zebulon1.0.0
