...
CONFIG += debug 
QT = core gui
SOURCES += ClassPeriod.cpp Group.cpp Controller.cpp TutorialClassroom.C Student.cpp main.cpp Module.cpp MagistralClass.cpp Gui/QTimeSlot.cpp PracticalClass.cpp Classroom.cpp sqlite/lib/sqlite3.c LectureHall.C Gui/QSchedule.cpp TimeSlot.cpp Schedule.cpp TutorialClass.cpp Date.cpp Gui/WindowEditTimeSlot.cpp PracticalClassroom.cpp sqlite/Database.cpp Gui/mainwindow.cpp
